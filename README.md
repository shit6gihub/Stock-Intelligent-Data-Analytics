...
<details>
<summary><b>🧠 智能 Agent 系统（4 套）</b></summary>
...
- **当前版本**：`v0.1.3`（镜像 tag 与 GitHub Release 对齐）
- **容器镜像**：`ghcr.io/xiaoze-hub/stock-intelligent-data-analytics:latest`（已公开，匿名可拉，digest `sha256:51199eb9eaee`）
- **更新日志**：见 [Releases](https://github.com/xiaoze-hub/Stock-Intelligent-Data-Analytics/releases)
- 打 tag（如 `v0.1.4`）触发 GitHub Actions 自动构建并推送镜像到 GHCR
