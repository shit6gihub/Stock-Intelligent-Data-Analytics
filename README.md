...
- **当前版本**：`v0.1.10`（镜像 tag 与 GitHub Release 对齐；设置页同花顺登录区块 + 数据源页补板块/大盘资金）
- **容器镜像**：`ghcr.io/xiaoze-hub/stock-intelligent-data-analytics:latest`（已公开，匿名可拉，digest `sha256:c0517880d18f`）
