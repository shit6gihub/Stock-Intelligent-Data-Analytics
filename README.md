...
- **当前版本**：`v0.1.6`（镜像 tag 与 GitHub Release 对齐；新增影子账户 Shadow Account + CI 强制门禁 typecheck+pytest）
- **容器镜像**：`ghcr.io/xiaoze-hub/stock-intelligent-data-analytics:latest`（已公开，匿名可拉，digest `sha256:025bc8df8e67`）
