...
- **当前版本**：`v0.1.9`（镜像 tag 与 GitHub Release 对齐；数据源设置页可维护 + 同花顺登录集成到设置）
- **容器镜像**：`ghcr.io/xiaoze-hub/stock-intelligent-data-analytics:latest`（已公开，匿名可拉，digest `sha256:ebb23f051609`）
